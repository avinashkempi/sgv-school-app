    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Text style={[styles.titleLarge, { color: colors.onSurface }]}>
              Select Date Range
            </Text>
          ...
          >
            <Button variant="outlined" onPress={onClose} style={{ flex: 1 }}>
              Cancel
            </Button>
            <Button variant="filled" onPress={handleApply} style={{ flex: 1 }}>
              Apply
            </Button>
          </View>
        </View>
