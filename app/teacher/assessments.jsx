...
export default function AssessmentDashboard() {
  ...
  const createExamMutation = useApiMutation(
    `${apiConfig.baseUrl}/exams/standardized`,
    "POST"
  );
        ...
        { text: t("common.cancel", "Cancel"), style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              showToast(
                error.message ||
                  t("toasts.failedToCreateExam", "Failed to create exam"),
                "error"
              );
            }
          },
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 24 }}>
        {/* Class Selection */}
        <Text style={[localStyles.label, { color: colors.textPrimary }]}>
        ...
        {selectedClass && (
          <>
            <Text style={[localStyles.label, { color: colors.textPrimary }]}>
              {t("teacher.selectSubject", "Select Subject")}
            </Text>
            <ScrollView
              horizontal
              showsHorizontalScrollIndicator={false}
        ...
        {selectedClass && selectedSubject ? (
          ...
          <View style={{ alignItems: "center", marginTop: 60 }}>
            ...
            >
              {t(
                "teacher.selectClassSubjectToViewExams",
