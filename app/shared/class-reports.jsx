...
export default function ClassReportsDashboard() {
  ...
  const {
    ...
    `${apiConfig.baseUrl}/marks/analytics/class/${selectedClass}${
  ...
  const trendChartData = useMemo(() => {
    ...
    return {
      ...
      datasets: [
        {
          data: subjectData.summary.map(
            (s) => parseFloat(s.avgPercentage) || 0
          ),
  ...
  const topPerformersData = useMemo(() => {
    ...
    return {
      labels: analyticsData.studentRankings
        .slice(0, 5)
        .map((s, i) => `#${i + 1}`),
      datasets: [
        {
      ...
      <View>
        ...
        >
          ...
          <StatCard
            ...
            value={`${analyticsData?.totalMarksObtained || 0}/${
    ...
    return (
      <View style={{ marginBottom: 20 }}>
        <PerformanceChart
          ...
          subtitle={t(
            "reports.gradeDistributionSubtitle",
    ...
    return (
      <View style={{ marginBottom: 20 }}>
        <PerformanceChart
          ...
          subtitle={t(
            "reports.performanceTrendsSubtitle",
            "Exam-wise average progression"
          )}
          yAxisSuffix="%"
        />
      </View>
  ...
  const renderTopPerformers = () => {
    if (!topPerformersData || topPerformersData.labels.length === 0)
      return null;
    ...
    return (
      <View style={{ marginBottom: 20 }}>
        ...
        {rankings.map((student) => {
          ...
          const isExpanded =
            expandedStudentId === (student.studentId || student._id);
            ...
            <Pressable
              ...
              onPress={() =>
                setExpandedStudentId(
                  isExpanded ? null : student.studentId || student._id
                )
              }
              style={({ pressed }) => ({
                ...
                <View style={{ alignItems: "flex-end", marginLeft: 12 }}>
                  ...
                  >
                    ...
                    >
                      ...
                      {t("reports.subjectsCount", "subjects")}
                    </Text>
                    <MaterialIcons
                      name={
      ...
      >
        <View style={{ padding: 16, paddingTop: 24 }}>
          <Header
            ...
            subtitle={t(
              "reports.performanceAnalyticsInsights",
