...
export default function StudentHistoryScreen() {
  ...
  const fetchHistory = async () => {
    try {
      ...
      const response = await apiFetch(
        `${apiConfig.baseUrl}/reports/history/me`
      );
      if (response.ok) {
  ...
  if (loading && !refreshing) {
    return (
      <LoadingState
        message={t(
          "student.retrievingAcademicHistory",
          "Retrieving your academic history..."
        )}
      />
    );
  }
      ...
      >
        ...
        {historyData.length === 0 ? (
          <EmptyState
            ...
            message={t(
              "student.noArchivedRecords",
              "Looks like you don't have any archived academic records yet."
            )}
          />
        ) : (
                ...
                <View style={{ padding: 20 }}>
                    ...
                    >
                      ...
                      >
                        {record.academicYear?.name ||
                          t("student.unknownYear", "Unknown Year")}
                      </Text>
                    </View>
                  </View>
                  ...
                  >
                    <View>
                      ...
                      >
                        {t(
                          "student.status_" + record.finalStatus,
                          record.finalStatus
                        )}
                      </Text>
                    </View>
                    ...
                    <View>
                      ...
                      >
                        {record.totalAttendancePercentage
                          ? `${record.totalAttendancePercentage}%`
                          : t("common.na", "N/A")}
                      </Text>
                    </View>
