...
const createStyles = (colors) =>
  StyleSheet.create({
    ...
    historyStatusText: { color: "#fff", fontFamily: FONTS.bold, fontSize: FONT_SIZES.lg },
    historyInfo: { flex: 1 },
    historyDate: { fontSize: FONT_SIZES.md, fontFamily: FONTS.bold, color: colors.textPrimary },
    historyTime: { fontSize: FONT_SIZES.xs, fontFamily: FONTS.regular, color: colors.textSecondary },
    historyRemarks: {
      fontSize: FONT_SIZES.sm,
      fontFamily: FONTS.regular,
      color: colors.textSecondary,
    ...
    studentName: { fontSize: FONT_SIZES.md, fontFamily: FONTS.medium, color: colors.textPrimary },
    miniStatus: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
    miniStatusText: { color: "#fff", fontSize: FONT_SIZES.micro, fontFamily: FONTS.bold },
    emptyText: {
      textAlign: "center",
      marginTop: 20,
      fontSize: FONT_SIZES.sm,
    ...
    absentName: { fontSize: FONT_SIZES.md, fontFamily: FONTS.bold, color: colors.textPrimary },
    absentRole: { fontSize: FONT_SIZES.xs, fontFamily: FONTS.regular, color: colors.textSecondary },
    absentTag: {
    ...
    absentTagText: { color: colors.error, fontSize: FONT_SIZES.micro, fontFamily: FONTS.bold },
    actionHeader: {
      flexDirection: "row",
