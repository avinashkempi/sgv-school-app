    ...
    >
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          {/* M3 Navigation Banner to Daily Reminders Hub */}
          <Pressable
            onPress={() => router.push("/admin/daily-reminders")}
            accessibilityRole="button"
            accessibilityLabel="Open Daily Reminders Hub"
            style={({ pressed }) => [
              {
                flexDirection: "row",
                alignItems: "center",
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                Manage scheduled birthday greetings, exam alerts, event eve reminders, and audit logs.
              </Text>
            </View>
            <MaterialIcons
              name="chevron-right"
