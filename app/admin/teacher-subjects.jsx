...
export default function TeacherSubjectsScreen() {
  ...
  const assignSubjectsMutation = useApiMutation({
    ...
    onSuccess: (results, _variables) => {
      ...
      showToast(
        `Successfully assigned ${successCount} subject(s) to ${selectedTeacher.name}`,
        "success"
      );
  ...
  const removeSubjectMutation = useApiMutation({
    ...
    onError: (_error) =>
      showToast("Failed to remove teacher from subject", "_error"),
  });
                  ...
                  return (
                    <Pressable
                      ...
                      style={({ pressed }) => ({
                        ...
                        marginBottom: 10,
                        opacity:
                          isAssigned || assignSubjectsMutation.isPending
                            ? 0.6
                            : pressed
                            ? 0.9
                            : 1,
