...
export default function AdminPerformanceScreen() {
  ...
  const schoolAvg =
    completedExams.length > 0
      ? (
          completedExams.reduce((sum, e) => sum + e.avgPercentage, 0) /
        ...
        >
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              >
                {exam.examsCount} exam{exam.examsCount !== 1 ? "s" : ""} •{" "}
                {exam.marksEntered} mark entries
              </Text>
            </View>
            <Text
              style={{
    ...
    <View>
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  {cls.examsCount} exam{cls.examsCount !== 1 ? "s" : ""}{" "}
                  completed
                </Text>
              </View>
            </View>
      ...
      {classwiseSummary.length === 0 && (
        <View style={{ alignItems: "center", marginTop: 40, opacity: 0.6 }}>
          ...
          <Text
            style={{ color: colors.textSecondary, marginTop: 16, fontSize: 16 }}
          >
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  {subj.examsCount} exam{subj.examsCount !== 1 ? "s" : ""}{" "}
                  completed
                </Text>
              </View>
            </View>
          ...
          >
            ...
            <TouchableOpacity
              style={{
                ...
                alignItems: "center",
                backgroundColor:
                  activeTab === "classes" ? colors.primary : "transparent",
                borderRadius: 10,
              }}
            ...
            <TouchableOpacity
              style={{
                ...
                alignItems: "center",
                backgroundColor:
                  activeTab === "subjects" ? colors.primary : "transparent",
                borderRadius: 10,
              }}
