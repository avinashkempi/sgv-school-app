...
export default function CreateYearScreen() {
  ...
  const createMutation = useApiMutation({
    ...
    onError: (error) =>
      showToast(error.message || "Failed to create year", "error"),
  });
      ...
      >
        ...
        <View style={{ marginTop: 24 }}>
          ...
          >
            ...
            >
              After creating the year, you can add terms, configure holidays,
              and set up the academic calendar from the year details screen.
            </Text>
          </View>
