...
const AnimatedCategoryIcon = memo(({ type, isRead, colors }) => {
  ...
  const iconColor = isRead ? colors.onSurfaceVariant : config.color;
            ...
            <View style={styles.cardBody}>
              ...
              <View style={styles.metaRow}>
                ...
                <View style={styles.actionRow}>
                  {!notif.isRead && <AnimatedUnreadDot color={config.color} />}
                  {isAdmin && (
                    <Pressable
                      onPress={(e) => {
                        e.stopPropagation?.();
...
export default function NotificationsScreen() {
  ...
  const updatePreferencesMutation = useApiMutation({
    ...
    onError: () => {
      showToast(
        t("toasts.failedToUpdateSettings", "Failed to update settings"),
        "error"
      );
    },
  });
  ...
  const handleDelete = useCallback(
    (id) => {
      Alert.alert(
        ...
        t(
          "alerts.deleteNotificationMessage",
        ...
        [
          { text: t("common.cancel", "Cancel"), style: "cancel" },
          {
            ...
            onPress: async () => {
              ...
              if (success) {
                showToast(
                  t("toasts.notificationDeleted", "Notification deleted"),
                  "success"
                );
              } else {
                showToast(
                  t(
                    "toasts.failedToDeleteNotification",
        ...
        >
          ...
          >
            ...
            >
                ...
                {[
                  {
                    ...
                    desc: "Daily tasks, homework postings, and notes",
                    type: "Homework",
                  },
                  {
                    key: "exam",
                    label: "Exams & Results",
                    desc: "Exam schedules, seating, and report cards",
                    type: "Exam",
                  },
                  {
                    key: "fee",
                    label: "Fee Reminders",
                    desc: "Due dates, receipts, and payment alerts",
                    type: "Fee",
                  },
                  {
                    key: "event",
                    label: "School Events",
                    desc: "Celebrations, sports, meetings, and holidays",
                    type: "Event",
                  },
                  {
                    key: "general",
                    label: "General Announcements",
                    desc: "School broadcasts, news, and urgent alerts",
                    type: "General",
                  },
                ].map((item) => {
                  ...
                  return (
                      ...
                      style={[
                        styles.preferenceCard,
                        {
                          backgroundColor: isDarkMode
                            ...
                            : colors.surfaceContainerLowest || "#F8F9FE",
                          borderColor: isDarkMode
                            ? "rgba(255,255,255,0.06)"
                            : "rgba(0,0,0,0.05)",
                        },
                    ...
                    >
                      ...
                      <Switch
                        ...
                        trackColor={{
                          false: colors.outlineVariant || "#CBD5E1",
                          true: colors.primary,
                        }}
              ...
              >
                <Text style={styles.modalDoneButtonText}>Save & Close</Text>
              </Pressable>
            </Pressable>
          </Pressable>
        </Modal>
