...
export default function SubjectsScreen() {
  ...
  const {
    ...
    `${apiConfig.baseUrl}/classes/${
      user?.currentClass?._id || user?.currentClass
    }/full-details`,
    {
        ...
        classes.map(async (cls) => {
          try {
            const res = await apiFetch(
              `${apiConfig.baseUrl}/classes/${cls._id}/full-details`
            );
            if (res.ok) {
  ...
  const loading =
    loadingUser || (user?.role === "student" ? loadingStudent : loadingTeacher);
          ...
          <Card
            ...
            onPress={() =>
              router.push({
                ...
                params: {
                  id: user.currentClass._id || user.currentClass,
